...
vector<double> btag_yields_nb2_LT(TString process, TString year, double mass){
            
       TString btag_comb = "LT";
       ...
       TFile* file = TFile::Open(dir+filestart+process+"_"+year+"nb2_LT"+filetype,"READ");
       
       TTree* tree_in = (TTree*)file->Get("tree");

       bool flag_20L_20T, flag_pass_mlb_all_T;
       ...
       tree_in->SetBranchAddress("flag_20L_20T",&flag_20L_20T);
       tree_in->SetBranchAddress("flag_pass_mlb_all_T",&flag_pass_mlb_all_T);
       ...
       for (Long64_t event = 0; event < tree_in->GetEntries(); ++event){
            ...
            if ( m_ll >= lower_bound && m_ll <= upper_bound ){
                 ...
                 if ( flag_pass_mlb_all_T && !flag_20L_20T ){
       ...
       TFile* file_DY = TFile::Open("temp_data/output_DrellYan_2018nb2_LT.root","READ");
       ...
       tree_DY->SetBranchAddress("flag_20L_20T",&flag_20L_20T);
       tree_DY->SetBranchAddress("flag_pass_mlb_all_T",&flag_pass_mlb_all_T); 
       ...
       TFile* file_tt = TFile::Open("temp_data/output_ttbar_2018nb2_LT.root","READ");
       ...
       tree_tt->SetBranchAddress("flag_20L_20T",&flag_20L_20T);
       tree_tt->SetBranchAddress("flag_pass_mlb_all_T",&flag_pass_mlb_all_T);
