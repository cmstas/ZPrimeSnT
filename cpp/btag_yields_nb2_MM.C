...
vector<double> btag_yields_nb2_MM(TString process, TString year, double mass){
            
       TString btag_comb = "MM";
       ...
       TFile* file = TFile::Open(dir+filestart+process+"_"+year+"nb2_MM"+filetype,"READ");
       ...
       tree_in->SetBranchAddress("flag_MM",&flag_MM);
       tree_in->SetBranchAddress("flag_MM_1b",&flag_MM_1b);
       ...
       TFile* file_DY = TFile::Open("temp_data/output_DrellYan_2018nb2_MM.root","READ");
       ...
       tree_DY->SetBranchAddress("flag_MM",&flag_MM);
       tree_DY->SetBranchAddress("flag_MM_1b",&flag_MM_1b); 
       ...
       TFile* file_tt = TFile::Open("temp_data/output_ttbar_2018nb2_MM.root","READ");
       ...
       tree_tt->SetBranchAddress("flag_MM",&flag_MM);
       tree_tt->SetBranchAddress("flag_MM_1b",&flag_MM_1b);
