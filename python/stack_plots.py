...
sampleLineColor["DY3"]      = ROOT.kCyan
sampleLineColor["DYp3"]     = ROOT.kRed
sampleLineColor["B3mL2"]    = ROOT.kMagenta
...
sampleLegend["B3mL2"]    = ("B_{3}-L_{2}"+(" signal MC" if args.noSelPrint else "")) if not args.genericLFU else "Signal"
sampleLegend["DYbb"]     = "DY(#mu#mu)+bb"
sampleLegend["ZToMuMu"]  = "DY(#mu#mu)"
sampleLegend["ttbar"]    = "t#bar{t}"
sampleLegend["tW+tZq"]   = "tW+tZq"
sampleLegend["TTX"]      = "t#bar{t}V"
sampleLegend["WW"]       = "WW"
sampleLegend["ZZ"]       = "ZZ"
sampleLegend["WZ"]       = "WZ"
